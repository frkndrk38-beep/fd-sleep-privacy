...
FD Sleep Tracker may use:

- Microphone access for sleep sound detection and analysis
- Local device storage for sleep records, notes, preferences, statistics, and audio recordings
- Notification permission for sleep and wake-up reminders
- Internet access for Google AdMob advertising services

FD Sleep Tracker does not require users to create an account.
...
Sleep records, notes, preferences, and related statistics remain on the user’s device until the user deletes them, clears the application data, or uninstalls the application.

Sleep audio recordings are stored locally and are automatically deleted after approximately 30 days. Users may delete individual recordings earlier from within the application.
